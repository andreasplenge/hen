...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-50 w-8 h-8 flex items-center justify-center rounded-full text-muted-foreground hover:text-foreground transition-colors"
    >
      {isDark ? (
